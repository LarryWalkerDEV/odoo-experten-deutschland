        ...
        <div className="max-w-full md:max-w-7xl mx-auto">
          <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2 sm:mb-3 md:mb-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button className="touch-target"
                  ...
                  className="px-4 sm:px-6 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                >
                  Nur notwendige
                </button>
                ...
                <button className="touch-target"
                  ...
                  className="px-4 sm:px-6 py-2.5 bg-violet-600 text-white rounded-lg font-medium hover:bg-violet-700 transition-colors"
                >
                  Alle akzeptieren
                </button>
                ...
                <button className="touch-target"
                  ...
                  className="px-4 sm:px-6 py-2.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                >
                ...
                <Link
                  ...
                  className="px-4 sm:px-6 py-2.5 text-violet-600 dark:text-violet-400 hover:underline font-medium flex items-center"
                >
                  Cookie-Richtlinien
                </Link>
              </div>
          ...
          {showDetails && (
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              <h4 className="mobile-text text-sm font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3 md:mb-4">
                Cookie-Kategorien
              </h4>
